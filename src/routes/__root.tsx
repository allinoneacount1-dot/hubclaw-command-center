  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold">Signal lost in the mesh</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This coordinate doesn't exist in the HubClaw network.
        </p>
        <div className="mt-6">
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Recalibrating telemetry. Please retry.</p>
        <div className="mt-6 flex justify-center gap-2">
          ...
          <a href="/" className="rounded-md border border-input px-4 py-2 text-sm font-medium hover:bg-accent/10">Home</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "The operator-grade registry, sandbox, and telemetry control plane for production AI agents." },
      { property: "og:title", content: "HubClaw — GitHub for AI Agents" },
      { property: "og:description", content: "The operator-grade registry, sandbox, and telemetry control plane for production AI agents." },
